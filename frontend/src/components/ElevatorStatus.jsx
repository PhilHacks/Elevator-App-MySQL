...
function ElevatorStatus() {
      ...
      axios
        ...
        .catch((error) => {
          const errorMessage =
            ...
            "Unable to fetch elevator status. Please try again later.";
  ...
  return (
    <div>
      ...
      <ul>
        {status.map((elevator) => (
          <li key={elevator.elevatorId}>
            Elevator {elevator.elevatorId}: Currently at floor{" "}
            {elevator.currentFloor}, Status: {elevator.currentStatus}
          </li>
        ))}
      </ul>
